...
void
CrnnPost::CalcMindXOutputIndex(int64_t *resHostBuf, size_t batchSize, size_t objectNum,
...
void CrnnPost::CalcLiteOutputIndex(int32_t *resHostBuf, size_t batchSize, size_t objectNum,
                                   std::vector<std::string> &resVec) {
    LogDebug << "Start to Process CalcMindXOutputIndex.";
