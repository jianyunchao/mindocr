...
Status ClsInferProcess::Init(CommandParser &options, ModuleInitArgs &initArgs) {
...
Status ClsInferProcess::ParseConfig(CommandParser &options, ModuleInitArgs &initArgs) {
...
Status ClsInferProcess::LiteModelInfer(const std::shared_ptr<CommonData> &data) {
...
Status ClsInferProcess::MindXModelInfer(const std::shared_ptr<CommonData> &data) {
