...
Status DbnetInferProcess::Init(CommandParser &options, ModuleInitArgs &initArgs) {
...
Status DbnetInferProcess::ParseConfig(CommandParser &options, ModuleInitArgs &initArgs) {
